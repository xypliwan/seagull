...
<template>
  <div class="account-login">
    ...
    <div class="go-regist">
      还没有账号?
      <span @click="goRegist">立即创建新账号</span>
    </div>
  </div>
</template>
...
import { setLocalStorage, setCookie } from '@/utils/localStorage';
    ...
    async goLogin() {
      if (!this.params.username.length) {
        ...
        try {
          ...
          setLocalStorage('userinfo', datas.data);
          setCookie('userinfo',datas.data)
